...
parser.add_argument("--train-dataset", type=str, default='/home/cilab/LabMembers/DJ/sr_dataset/speech_command/train', help='path of train dataset')
parser.add_argument("--valid-dataset", type=str, default='/home/cilab/LabMembers/DJ/sr_dataset/speech_command/valid', help='path of validation dataset')
parser.add_argument("--background-noise", type=str, default='/home/cilab/LabMembers/DJ/sr_dataset/speech_command/train/_background_noise_', help='path of background noise')
