...
f = open("/home/knlab/Summer_study/Lab_members/YS/health_result.json","w")
f.close()
f = open("/home/knlab/Summer_study/Lab_members/YS/health_result_count.json","w")
f.close()
count = 0
error = []
for root, dirs, files in os.walk("/mnt/sdb/YS/youtube_data/건강/"):
    f1 = open("/home/knlab/Summer_study/Lab_members/YS/health_result.json","a")
    f2 = open("/home/knlab/Summer_study/Lab_members/YS/health_result_count.json","a")
    count += 1
    success_count = 0
