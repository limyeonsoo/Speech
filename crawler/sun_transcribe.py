...
def transcribe_file(speech_file):
 ...
 #       encoding=enums.RecognitionConfig.AudioEncoding.LINEAR16,
    ...
    try:
        ...
        return(" * ")
keyword_result = {}
f = open("/home/knlab/Summer_study/Lab_members/YS/result_tenp4.txt","w")
for root, dirs, files in os.walk("/mnt/sdb/YS/youtube_data/태양광/"):
    for directory in tqdm(dirs[124:]):
        #temp = []
        count = 0
